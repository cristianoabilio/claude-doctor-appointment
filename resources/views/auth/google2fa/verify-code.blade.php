                            ...
                            <div class="col-md-7 mx-auto">
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="pt-0">
                                        ...
                                        <form action="{{ route('google2fa.login') }}" method="POST" class="my-4">
                                            @csrf
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <x-text-input id="verify_code" class="form-control block mt-1 w-full" type="text" name="verify_code" :value="old('verify_code')" required autofocus autocomplete="verify code" />
